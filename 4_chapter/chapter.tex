...
was performed. All algorithms used \texttt{MlpPolicy} except RPPO, which
...
Table~\ref{tab:poi} and Figure~\ref{fig:poi} report the pairwise
probability of improvement $P(A > B)$, averaged across environments.
PPO has $P > 0.89$ against every other algorithm.
