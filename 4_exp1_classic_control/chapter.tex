...
using all of the metrics defined in Section~\ref{sec:eval-framework}, following the
...
\begin{table}[htbp!]
\centering
\caption[SB3 default hyperparameters used for all algorithms]{SB3 default hyperparameters used for all algorithms. No per-algorithm tuning was performed.}
...
These hypotheses are grounded in the literature reviewed in Chapter~\ref{chap:lit-review}, particularly \citet{mnih2015human} for DQN and \citet{schulman2017ppo} for PPO.
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=\linewidth]{4_exp1_classic_control/assets/learning_curves_cartpole-v1.png}
  \caption[Learning curves for CartPole-v1]{Learning curves for CartPole-v1. PPO and A2C converge to the
...
Extending the training budget to confirm this interpretation is left as future work (see Chapter~\ref{chap:conclusions}).
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=\linewidth]{4_exp1_classic_control/assets/learning_curves_acrobot-v1.png}
  \caption[Learning curves for Acrobot-v1]{Learning curves for Acrobot-v1. A2C and PPO both converge
...
The RPPO collapse on Acrobot is noted as a failure case and discussed further in the limitations section. Testing RPPO on a POMDP environment where memory is genuinely needed is left as future work.
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=\linewidth]{4_exp1_classic_control/assets/learning_curves_lunarlander-v3.png}
  \caption[Learning curves for LunarLander-v3]{Learning curves for LunarLander-v3. PPO achieves the highest
...
\begin{figure}[htbp!]
  ...
  \caption[Combined learning curves: classic-control benchmark]{Combined normalised learning curves across all three
...
\begin{figure}[htbp!]
  ...
  \caption[Score distributions: classic-control benchmark]{Distribution of normalised scores per environment. PPO is
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=\linewidth]{4_exp1_classic_control/assets/per_seed_heatmap.png}
  \caption[Per-seed score heatmap: classic-control benchmark]{Heatmap of normalised final scores by seed and environment.
...
\begin{figure}[htbp!]
  ...
  \caption[Per-seed score spread: classic-control benchmark]{Box-and-swarm plot of per-seed normalised scores. Individual
...
\begin{table}[htbp!]
\centering
\caption[Cross-environment aggregate metrics]{Cross-environment aggregate metrics (normalised scores). IQM,
...
\begin{figure}[htbp!]
  ...
  \caption[Cross-environment IQM: classic-control benchmark]{Cross-environment IQM, mean, and median with 95\% bootstrap
...
\begin{figure}[htbp!]
  ...
  \caption[Performance profiles: classic-control benchmark]{Performance profiles with 95\% bootstrap CIs. Higher curves
...
\begin{figure}[htbp!]
  ...
  \caption[Optimality gap: classic-control benchmark]{Optimality gap with 95\% bootstrap CIs. Lower values indicate
...
\begin{figure}[htbp!]
  ...
  \end{subfigure}
  \caption[Sample efficiency: classic-control benchmark]{Sample efficiency (normalised AUC) per environment and combined.
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.8\linewidth]{4_exp1_classic_control/assets/poi_heatmap.png}
  \caption[Probability of improvement: classic-control benchmark]{Probability-of-improvement heatmap. PPO dominates all pairwise
...
\begin{figure}[htbp!]
  ...
  \caption[Training time per algorithm: classic-control benchmark]{Wall-clock training time per algorithm and environment. RPPO
...
These limitations are addressed further in Chapter~\ref{chap:conclusions}.
