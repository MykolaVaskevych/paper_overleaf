...
\subsection{Why Local Training {\color{red} remove?}}
\label{sec:why-local}
...
\begin{enumerate}
  \item \textbf{RL bottlenecks on CPU, not GPU.} {\color{red} (REMOVE?)}
  ...
  \item \textbf{Deterministic seeding requires CPU-only execution. {\color{red} (REMOVE?)}}
