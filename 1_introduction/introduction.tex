...
This Final Year Project (FYP) compares and contrasts two families of Reinforcement Learning algorithms: Policy Gradient approaches and Value-based Functions. A set of gym environments for classic control and Atari are selected based on their properties, and serve as a test suit for the comparision. Metrics are defined that take account of training time,  performance, and ability to generalise. This FYP proposes a set of guidelines for novices to follow when choosing an RL algorithm to solve their specific problem.
...
In this report, I have presented my work in accordance with the submission requirements.
This first chapter introduced the idea of this project and my goals. Following chapters would cover next things:

In Literature review chapter: Covers basics of AI to make reader familiar with concepts that were used for this project. Including introduction of two RL families with some algorithms from them like PPO and DQN which are mainly used in experiments that were conducted and uppon which this report topic is based. It also covers tool that were used like SB3 and gymansium libraries. 

In Prototypes chapter: a short example of implementation of algorithms presented to provide a reader with understanding of how implementations were made for experiments of comparison and benchmarking is made. it Includes detailed implementation of DQN prototype algorithm on a game Atary Breakout and with results provided as well as full code implementation. And link to github of this project where reader can find all source code of this project. Including implementation of all algorithms used, scripts to train and evaluate models. Github also serves a purpose of a proof that student worked on this project by himself from Septemer and provides some statistics about the amount of work he has done like commit history and lines of code number. 

Next three chapters exp1-3 cover actuall expriments that student conducted. and they are a main work of this report which took place from winter break up to the deadline of the submission. give or take a week for polishing final report after they were finished. each experiment chapter has the next structure:
short summary of what this experiment is about and why it was conducted

experiment setup which gives explanation about which algorithms and enviroments were used including extra details of settings.

following by hypotheses of what was the expected outcomes based on Student understanding and intiution supported by literature review that was made and information from others people benchmarks and papers.

then training summary of what was done
following by per enviroment and crossenviroment results evaluation where actual ressults are presented  and analised.

then keyfinding where this results are compared with initial expectations and hypotheses to understant how good this experiment was, how expected results were

last subsections of experiments are threats of validity and discussion where student states his thoughs of how valid this experiment was and its results as well as what to do next (what i will do next i guess) or what this experiment gave us 

The chapter Evaluation summarizes findings from experiments, recals questions that this report tried to answer in goal from introduction chapter and tries to answer them.

The last chapter disscussion and conclusion  this finsihes this report with once again answering the questions in more short and powerfull manner, reflects on all work that was made and how difficault it was and states what can be done as a future work.
