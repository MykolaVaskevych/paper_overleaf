...
This chapter restates the research question, synthesises the findings
from all three experiments, provides a direct answer to the research
question, and then discusses the limitations of the work and directions
for future research.
...
The thesis was organised around a single research question:
...
\subsection{Experiment 2: Atari Benchmark (5M steps)}
...
\subsection{Experiment 3: Extended Atari Benchmark (20M steps)}
...
\begin{itemize}
  \item \textbf{ REMOVE??? Repeat Experiment~3 with the intended 400K DQN buffer
